...
export const Infantil = () => {
  return (
    <Image>
      ...
      <Box> <img alt="infantil8" src={infantil8} /></Box>
      <Box> <img alt="infantil9" src={infantil9} /></Box>
      <Box> <img alt="infantil10" src={infantil10} /></Box>
      <Box> <img alt="infantil11" src={infantil11} /></Box>
      <Box> <img alt="infantil12" src={infantil12} /></Box>
      <Box> <img alt="infantil13" src={infantil13} /></Box>
      <Box> <img alt="infantil14" src={infantil14} /></Box>
      <Box> <img alt="infantil15" src={infantil15} /></Box>
      <Box> <img alt="infantil17" src={infantil17} /></Box>
      <Box> <img alt="infantil18" src={infantil18} /></Box>
      <Box> <img alt="infantil19" src={infantil19} /></Box>
    </Image>
  )
}
